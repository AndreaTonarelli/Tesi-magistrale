...
for it in range(1, nsteps+1):
    ...
    cG  = SpeciesBCs(cG, nx,ny, xs1,xe1,ys1,ye1, xs2,xe2,ys2,ye2, xs3,xe3,ys3,ye3, xs4,xe4,ys4,ye4, xs5,xe5,ys5,ye5, xs6,xe6,ys6,ye6, xs7,xe7,ys7,ye7, xs8,xe8,ys8,ye8, xs9,xe9,ys9,ye9)
