...
gamma = gammaCoeff(gamma, hx,hy, nout_start,nout_end, X1, X2, X3, X4, X5, X6, X7, X8, X9)
...
cB[xe8+1:xe8+th+1, ys8:ye8] = cB0    # Obstacle 1
cB[xe9+1:xe9+th+1, ys9:ye9] = cB0    # Obstacle 1
...
for it in range(1, nsteps+1):
    ...
    uwall = 0
    u, v = VelocityBCs(u, v, uwall, X1, X2, X3, X4, X5, X6, X7, X8, X9)
    ...
    #----------------------------------------------------------------------------------#
    # Impermeable walls
    cO2 = SpeciesBCs(cO2, nx,ny, X1, X2, X3, X4, X5, X6, X7, X8, X9)
    cG  = SpeciesBCs(cG, nx,ny, X1, X2, X3, X4, X5, X6, X7, X8, X9)
...
ccB[xe8+1:xe8+th+1, ys8:ye8] = cB[xe8+1:xe8+th+1, ys8+1:ye8+1]  # Obstacle 8
ccB[xe9+1:xe9+th+1, ys9:ye9] = cB[xe9+1:xe9+th+1, ys9+1:ye9+1]  # Obstacle 9

# Addition of obstacles for graphical purposes
uu, vv, pp, ccO2, ccB, ccG = Graphical_obstacles(uu, vv, pp, ccO2, ccB, ccG, X1, X2, X3, X4, X5, X6, X7, X8, X9)
...
# Surface map: cG
PlotFunctions(xx, yy, ccG, x, y, X1, X2, X3, X4, X5, X6, X7, X8, X9, Lx, Ly, 'Glucose concentration [mol/m3]', 'x [m]', 'y [m]')
