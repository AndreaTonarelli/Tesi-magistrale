...
def gammaCoeff(gamma, hx,hy, nout_start,nout_end, X1, X2, X3, X4, X5, X6, X7, X8, X9):
...
def VelocityBCs(u, v, uwall, X1, X2, X3, X4, X5, X6, X7, X8, X9):
...
def SpeciesBCs(phi, nx,ny, X1, X2, X3, X4, X5, X6, X7, X8, X9):
