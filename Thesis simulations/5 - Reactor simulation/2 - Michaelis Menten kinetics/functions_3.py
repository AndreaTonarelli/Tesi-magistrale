...
def gammaCoeff(gamma, hx,hy, nout_start,nout_end, X1, X2, X3, X4, X5, X6, X7):
...
def VelocityBCs(u, v, uwall, X1, X2, X3, X4, X5, X6, X7):
...
def SpeciesBCs(phi, nx,ny, X1, X2, X3, X4, X5, X6, X7):
...
def Graphical_obstacles(uu, vv, pp, tau, ccO2, ccB, ccG, X1, X2, X3, X4, X5, X6, X7):
...
def PlotFunctions(xx, yy, phi, x, y, X1, X2, X3, X4, X5, X6, X7, Lx, Ly, title, x_label, y_label):
