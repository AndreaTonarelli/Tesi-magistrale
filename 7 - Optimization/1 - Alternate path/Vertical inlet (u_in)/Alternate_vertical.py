...
from   Alternate_vertical_functions import *
from   Alternate_vertical_obstacles_def import *
...
nin_start1 = 1         # first cell index (pay attention cause it is in MATLAB notation!)
nin_end1 = int(ys2/2)  # last cell index (pay attention cause it is in MATLAB notation!)
...
nout_start = 1        # first cell index (pay attention cause it is in MATLAB notation!)
...
u_out = (Ain1*u_in + Ain2*v_in + Ain3*v_in)/Aout
