...
ys_inlet, ye_inlet = Obstacles(x, y, Lx, Ly)[2]

# Inlet section (west side)
nin_start1 = ys_inlet # first cell index (pay attention cause it is in MATLAB notation!)
nin_end1 = ye_inlet   # last cell index (pay attention cause it is in MATLAB notation!)
...
filename = 'Alternate_vertical_1200x400.dat'
