...
def gammaCoeff(gamma, hx,hy, nout_start,nout_end, XX):
    ...
    gamma = gamma_corners_obst(gamma, X1, hx, hy, 'north')      # Obstacle 1
    gamma = gamma_corners_obst(gamma, X2, hx, hy, 'south')      # Obstacle 2
    gamma = gamma_corners_obst(gamma, X3, hx, hy, 'north')      # Obstacle 3
    gamma = gamma_corners_obst(gamma, X4, hx, hy, 'south')      # Obstacle 4
    gamma = gamma_corners_obst(gamma, X5, hx, hy, 'north')      # Obstacle 5
    gamma = gamma_corners_obst(gamma, X6, hx, hy, 'south')      # Obstacle 6
    gamma = gamma_corners_obst(gamma, X7, hx, hy, 'north')      # Obstacle 7
    gamma = gamma_corners_obst(gamma, X8, hx, hy, 'south')      # Obstacle 8
    gamma = gamma_corners_obst(gamma, X9, hx, hy, 'north')      # Obstacle 9
    xs10 = X10[0]; ys10 = X10[2]
    gamma[xs10-1, ys10] = hx*hy / (hx**2 + hy**2)               # Obstacle 10
