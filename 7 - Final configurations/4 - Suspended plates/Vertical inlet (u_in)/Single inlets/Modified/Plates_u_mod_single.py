...
from   Plates_u_mod_single_functions import *
from   Plates_u_mod_single_obstacles_def import *
...
X1_1 = XX[0]; X2_1 = XX[1]; X3_1 = XX[2]; X4_1 = XX[3]; X5_1 = XX[4]; X6_1 = XX[5]; X7_1 = XX[6]; X8_1 = XX[7]
X1_2 = XX[8]; X2_2 = XX[9]; X3_2 = XX[10]; X4_2 = XX[11]; X5_2 = XX[12]; X6_2 = XX[13]; X7_2 = XX[14]; X8_2 = XX[15]
X23 = XX[-2]; xs23 = X23[0]; xe23 = X23[1]; ys23 = X23[2]; ye23 = X23[3]
X24 = XX[-1]; xs24 = X24[0]; xe24 = X24[1]; ys24 = X24[2]; ye24 = X24[3]
...
Ain = hy*(nin_end1-nin_start1+1)      # inlet section area [m]
...
cBmean1 = cBmean2 = cBmean3 = cBmean4 = cBmean5 = cBmean6 = cBmean7 = cBmean8 = np.empty(0)
cB1out = t_vector = cO2_max = cGlc_max = cGln_max = cAmm_max = cLac_max = cB1_max = u_max = v_max = np.empty(0)
...
Xv = ImmobilizedCells(Xv, Xv0, X1_1, X1_2, th, cells_position)  # Obstacle 1
...
cB1 = ImmobilizedCells(cB1, cB1_0, X1_1, X1_2, th, cells_position)  # Obstacle 1
...
for it in range(1, nsteps+1):
    ...
    Qin  = np.mean(u[0, nin_start1-1:nin_end1+1])*Ain    # inlet flow rate [m2/s]
    ...
    cBmean1 = np.append(cBmean1, CellsMeanConcentration(Xv, th, X1_1, X1_2, cells_position)) # (pay attention if cells are above or under the plate!!!)
    cBmean2 = np.append(cBmean2, CellsMeanConcentration(Xv, th, X2_1, X2_2, cells_position))
...
filename = f'Plates_vertical_mod_{nx}x{ny}_{Time/3600}h.dat'
...
ccXv = Interpolation_of_cells(ccXv, Xv, X1_1, X1_2, th, cells_position)  # Obstacle 1
