...
from   Diffusive_horizontal_functions import *
from   Diffusive_horizontal_obstacles_def import *
...
nin_end2 = xs2 - 1      # last cell index
...
u_out = (Ain1*v_in + Ain2*v_in)/Aout
...
cBmean2 = cBmean3 = cBmean5 = cBmean6 = cBmean8 = cBmean9 = cBmean11 = cBmean12 = cBmean14 = cBmean15 = cB1out = t_vector = np.empty(0)
...
v[nin_start2-1:nin_end2+1 , 0] =  v_in
...
for it in range(1, nsteps+1):
    ...
    v[nin_start1-1:nin_end1+1, -1] = -v_in     # fixed inlet velocity (west)
    v[nin_start2-1:nin_end2+1 , 0] =  v_in
    ...
    vt[nin_start1-1:nin_end1+1, -1] = -v_in     # fixed inlet velocity (west)
    vt[nin_start2-1:nin_end2+1 , 0] =  v_in
    ...
    if OnTheFly == 'Yes' and it % 250 == 1:
        ...
        ccGlc = node_interp(cAmm, 'p', nx, ny, flagp)
...
# Mean values of cB
MeanCellsPlot(t_vector, [cBmean2, cBmean3, cBmean5, cBmean6, cBmean8, cBmean9, cBmean11, cBmean12, cBmean14, cBmean15], Time, Xv0)
