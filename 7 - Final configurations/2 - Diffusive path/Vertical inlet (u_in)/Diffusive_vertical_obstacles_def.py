...
def Obstacles(x, y, Lx, Ly):
    ...
    x_obst1_start = 0.
    x_obst1_end = 0.05
    y_obst1_start = 0. + 0.073
    y_obst1_end = Ly - 0.073
    # Obstacle 2
    x_obst2_start = Lx/9
    x_obst2_end = Lx/9 + 0.1
    y_obst2_start = 0.
    y_obst2_end = Ly/2 - 0.2
    # Obstacle 3
    x_obst3_start = Lx/9
    x_obst3_end = Lx/9 + 0.1
    y_obst3_start = Ly/2 + 0.2
    y_obst3_end = Ly
    # Obstacle 4
    ...
    y_obst5_start = 0.
    y_obst5_end = Ly/2 - 0.2
    # Obstacle 6
    x_obst6_start = 3*Lx/9
    x_obst6_end = 3*Lx/9 + 0.1
    y_obst6_start = Ly/2 + 0.2
    y_obst6_end = Ly
    # Obstacle 7
    ...
    y_obst8_start = 0.
    y_obst8_end = Ly/2 - 0.2
    # Obstacle 9
    x_obst9_start = 5*Lx/9
    x_obst9_end = 5*Lx/9 + 0.1
    y_obst9_start = Ly/2 + 0.2
    y_obst9_end = Ly
    # Obstacle 10
    ...
    y_obst11_start = 0.
    y_obst11_end = Ly/2 - 0.2
    # Obstacle 12
    x_obst12_start = 7*Lx/9
    x_obst12_end = 7*Lx/9 + 0.1
    y_obst12_start = Ly/2 + 0.2
    y_obst12_end = Ly
    # Obstacle 13
    ...
    x_obst14_end = Lx + 0.2
    y_obst14_start = 0.
    y_obst14_end = Ly/2 - 0.2
    # Obstacle 15
    x_obst15_start = Lx + 0.1
    x_obst15_end = Lx + 0.2
    y_obst15_start = Ly/2 + 0.2
    y_obst15_end = Ly
    ...
    X_obst2 = defining_obstacles(x_obst2_start, x_obst2_end, y_obst2_start, y_obst2_end, x_obst4_start, n, m, p, 'south')
    X_obst3 = defining_obstacles(x_obst3_start, x_obst3_end, y_obst3_start, y_obst3_end, x_obst4_start, n, m, p, 'north')
    ...
    X_obst6 = defining_obstacles(x_obst6_start, x_obst6_end, y_obst6_start, y_obst6_end, x_obst7_start, n, m, p, 'north')
    X_obst7 = [x_obst7_start, x_obst7_end, y_obst7_start, y_obst7_end]
    X_obst8 = defining_obstacles(x_obst8_start, x_obst8_end, y_obst8_start, y_obst8_end, x_obst10_start, n, m, p, 'south')
    X_obst9 = defining_obstacles(x_obst9_start, x_obst9_end, y_obst9_start, y_obst9_end, x_obst10_start, n, m, p, 'north')
    ...
    X_obst12 = defining_obstacles(x_obst12_start, x_obst12_end, y_obst12_start, y_obst12_end, x_obst13_start, n, m, p, 'north')
