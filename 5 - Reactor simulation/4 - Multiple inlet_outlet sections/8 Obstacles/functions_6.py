...
def gammaCoeff(gamma, hx,hy, nout_start1,nout_end1, nout_start2,nout_end2, nout_start3,nout_end3, X1, X2, X3, X4, X5, X6, X7, X8):
    ...
    gamma[-2, nout_start1-1:nout_end1-1] = hx*hy / (2*hx**2 + 2*hy**2)    # Outlet sections are treated as an internal cell
    gamma[nout_start2-1:nout_end2-1, -2] = hx*hy / (2*hx**2 + 2*hy**2)
    gamma[nout_start3-1:nout_end3-1,  1] = hx*hy / (2*hx**2 + 2*hy**2)
    gamma[-2, nout_start1-1]            = hx*hy / (  hx**2 + 2*hy**2)    # Corners of outlet sections
    gamma[-2, nout_end1-1]              = hx*hy / (  hx**2 + 2*hy**2)
    gamma[nout_start2-1, -2]            = hx*hy / (  hx**2 + 2*hy**2)
    gamma[nout_end2-1, -2]              = hx*hy / (  hx**2 + 2*hy**2)
    gamma[nout_start3-1,  1]            = hx*hy / (  hx**2 + 2*hy**2)
    gamma[nout_end3-1,  1]              = hx*hy / (  hx**2 + 2*hy**2)
