...
nout_start1 = 2        # first cell index (pay attention cause it is in MATLAB notation!)
nout_end1 = ys8 - 1    # last cell index (pay attention cause it is in MATLAB notation!)
# Outlet section 1 (north side)
nout_start2 = xe2 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end2 = int(xe2 + (xs3-xe2)/3)
# Outlet section 2 (south side)
nout_start3 = xe3 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end3 = int(xe3 + (xs4-xe3)/3)
# Outlet section 3 (north side)
nout_start4 = xe4 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end4 = int(xe4 + (xs5-xe4)/3)
# Outlet section 4 (south side)
nout_start5 = xe5 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end5 = int(xe5 + (xs6-xe5)/3)
# Outlet section 5 (north side)
nout_start6 = xe6 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end6 = int(xe6 + (xs7-xe6)/3)
# Outlet section 6 (south side)
nout_start7 = xe7 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end7 = int(xe7 + (xs8-xe7)/3)
# Outlet section 7 (north side)
nout_start8 = xe8 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end8 = int(xe8 + (xs9-xe8)/3)
# Outlet section 8 (south side)
nout_start9 = xe9 + 1  # first cell index (pay attention cause it is in MATLAB notation!)
nout_end9 = int(xe9 + (xs10-xe9)/3)

# Defining the outlet sections positions
nout_start = (nout_start1, nout_start2, nout_start3, nout_start4, nout_start5, nout_start6, nout_start7, nout_start8, nout_start9)
nout_end = (nout_end1, nout_end2, nout_end3, nout_end4, nout_end5, nout_end6, nout_end7, nout_end8, nout_end9)
...
for it in range(1, nsteps+1):
    ...
    u[-1, nout_start1-1:nout_end1+1] = u[-2, nout_start1-1:nout_end1+1]   # zero-gradient outlet velocity
    v[-1, nout_start1-1:nout_end1+1] = v[-2, nout_start1-1:nout_end1+1]   # zero-gradient outlet velocity
    u[-1, nout_start2-1:nout_end2+1] = u[-2, nout_start2-1:nout_end2+1]   # zero-gradient outlet velocity
    v[-1, nout_start2-1:nout_end2+1] = v[-2, nout_start2-1:nout_end2+1]   # zero-gradient outlet velocity
    u[-1, nout_start3-1:nout_end3+1] = u[-2, nout_start3-1:nout_end3+1]   # zero-gradient outlet velocity
    v[-1, nout_start3-1:nout_end3+1] = v[-2, nout_start3-1:nout_end3+1]   # zero-gradient outlet velocity
    u[-1, nout_start4-1:nout_end4+1] = u[-2, nout_start4-1:nout_end4+1]   # zero-gradient outlet velocity
    v[-1, nout_start4-1:nout_end4+1] = v[-2, nout_start4-1:nout_end4+1]   # zero-gradient outlet velocity
    u[-1, nout_start5-1:nout_end5+1] = u[-2, nout_start5-1:nout_end5+1]   # zero-gradient outlet velocity
    v[-1, nout_start5-1:nout_end5+1] = v[-2, nout_start5-1:nout_end5+1]   # zero-gradient outlet velocity
    u[-1, nout_start6-1:nout_end6+1] = u[-2, nout_start6-1:nout_end6+1]   # zero-gradient outlet velocity
    v[-1, nout_start6-1:nout_end6+1] = v[-2, nout_start6-1:nout_end6+1]   # zero-gradient outlet velocity
    u[-1, nout_start7-1:nout_end7+1] = u[-2, nout_start7-1:nout_end7+1]   # zero-gradient outlet velocity
    v[-1, nout_start7-1:nout_end7+1] = v[-2, nout_start7-1:nout_end7+1]   # zero-gradient outlet velocity
    u[-1, nout_start8-1:nout_end8+1] = u[-2, nout_start8-1:nout_end8+1]   # zero-gradient outlet velocity
    v[-1, nout_start8-1:nout_end8+1] = v[-2, nout_start8-1:nout_end8+1]   # zero-gradient outlet velocity
    u[-1, nout_start9-1:nout_end9+1] = u[-2, nout_start9-1:nout_end9+1]   # zero-gradient outlet velocity
    v[-1, nout_start9-1:nout_end9+1] = v[-2, nout_start9-1:nout_end9+1]   # zero-gradient outlet velocity
    ...
    ut[-1, nout_start1-1:nout_end1+1] = u[-1, nout_start1-1:nout_end1+1]   # zero-gradient outlet velocity
    vt[-1, nout_start1-1:nout_end1+1] = v[-1, nout_start1-1:nout_end1+1]   # zero-gradient outlet velocity
    ut[-1, nout_start2-1:nout_end2+1] = u[-1, nout_start2-1:nout_end2+1]   # zero-gradient outlet velocity
    vt[-1, nout_start2-1:nout_end2+1] = v[-1, nout_start2-1:nout_end2+1]   # zero-gradient outlet velocity
    ut[-1, nout_start3-1:nout_end3+1] = u[-1, nout_start3-1:nout_end3+1]   # zero-gradient outlet velocity
    vt[-1, nout_start3-1:nout_end3+1] = v[-1, nout_start3-1:nout_end3+1]   # zero-gradient outlet velocity
    ut[-1, nout_start4-1:nout_end4+1] = u[-1, nout_start4-1:nout_end4+1]   # zero-gradient outlet velocity
    vt[-1, nout_start4-1:nout_end4+1] = v[-1, nout_start4-1:nout_end4+1]   # zero-gradient outlet velocity
    ut[-1, nout_start5-1:nout_end5+1] = u[-1, nout_start5-1:nout_end5+1]   # zero-gradient outlet velocity
    vt[-1, nout_start5-1:nout_end5+1] = v[-1, nout_start5-1:nout_end5+1]   # zero-gradient outlet velocity
    ut[-1, nout_start6-1:nout_end6+1] = u[-1, nout_start6-1:nout_end6+1]   # zero-gradient outlet velocity
    vt[-1, nout_start6-1:nout_end6+1] = v[-1, nout_start6-1:nout_end6+1]   # zero-gradient outlet velocity
    ut[-1, nout_start7-1:nout_end7+1] = u[-1, nout_start7-1:nout_end7+1]   # zero-gradient outlet velocity
    vt[-1, nout_start7-1:nout_end7+1] = v[-1, nout_start7-1:nout_end7+1]   # zero-gradient outlet velocity
    ut[-1, nout_start8-1:nout_end8+1] = u[-1, nout_start8-1:nout_end8+1]   # zero-gradient outlet velocity
    vt[-1, nout_start8-1:nout_end8+1] = v[-1, nout_start8-1:nout_end8+1]   # zero-gradient outlet velocity
    ut[-1, nout_start9-1:nout_end9+1] = u[-1, nout_start9-1:nout_end9+1]   # zero-gradient outlet velocity
    vt[-1, nout_start9-1:nout_end9+1] = v[-1, nout_start9-1:nout_end9+1]   # zero-gradient outlet velocity
