...
from   functions_19 import *
from   Obstacles_def_multiple_v_mod_kinetics import *
...
v_in = 3e-3        # m/s   (inlet velocity)
v_in_l = 2e-3      # m/s   (inlet lateral velocity)
...
nin_start2 = xe3 + 1   # first cell index 
nin_end2 = xs4 - 1      # last cell index
...
for it in range(1, nsteps+1):
    ...
    vt[nin_start1:nin_end1+1, -1] = -v_in     # fixed inlet velocity (north)
